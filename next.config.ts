        ...
        headers: [
          {
            ...
            value: (() => {
              const directives = [
                ...
                isProd
                  ? "connect-src 'self' https://www.google.com https://apis.google.com https://accounts.google.com https://*.googleapis.com https://content-firebaseappcheck.googleapis.com https://*.firebaseio.com https://*.cloudfunctions.net https://firebasestorage.googleapis.com wss://*.firebaseio.com https://*.ingest.sentry.io https://*.sentry.io https://connect-backup-five.vercel.app https://connect-backup-git-master-henriques-projects-7f498294.vercel.app https://connect-backup-65lxk0nm1-henriques-projects-7f498294.vercel.app"
