...
import { BarChart, Users, Newspaper, FolderOpen, LayoutGrid, Activity, Eye } from 'lucide-react';
import { Bar, BarChart as BarChartComponent, ResponsiveContainer, XAxis, YAxis, Tooltip, Legend } from 'recharts';
...
export default function AnalyticsPage() {
  ...
  const kpiData = [
    ...
    { title: "Aplicações", value: applications.length, icon: LayoutGrid },
  ];
    ...
    <AdminGuard>
      <div className="space-y-6 p-6 md:p-8">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
         ...
         <Card>
            <CardHeader>
                <CardTitle className="font-headline">Conteúdos Desatualizados</CardTitle>
            </CardHeader>
            <CardContent>
                <p className="text-sm text-muted-foreground">
                    Esta funcionalidade ainda não está implementada.
                    <br />
                    No futuro, esta área exibirá uma lista de documentos e notícias que não são atualizados há muito tempo, sugerindo uma revisão.
                </p>
            </CardContent>
        </Card>
      </div>
