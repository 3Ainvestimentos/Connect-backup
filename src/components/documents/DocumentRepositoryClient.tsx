...
export default function DocumentRepositoryClient({ initialDocuments, categories, types }: DocumentRepositoryClientProps) {
  ...
  return (
    <div>
      <div className="mb-6 p-4 bg-card rounded-lg shadow sticky top-16 z-30"> {/* Adjust top-16 if header height changes */}
              ...
              {filteredAndSortedDocuments.map((doc) => (
                <TableRow key={doc.id} className="hover:bg-muted/30">
                  ...
                  <TableCell className="text-right">
                    <Button variant="ghost" size="icon" aria-label="Baixar documento">
