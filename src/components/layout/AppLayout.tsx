...
export const navItems = [
  ...
  { href: '/opportunity-map', label: 'Mapa de Oportunidades', icon: Compass, external: false, permission: 'canViewOpportunityMap' },
        ...
        {hasAdminPanels && (
          <>
            ...
            <DropdownMenuGroup>
                ...
                {isSuperAdmin && <DropdownMenuItem asChild><Link href="/admin/content?tab=opportunity-map" className="cursor-pointer font-body"><Compass className="mr-2 h-4 w-4" /><span>Mapa de Oportunidades</span></Link></DropdownMenuItem>}
