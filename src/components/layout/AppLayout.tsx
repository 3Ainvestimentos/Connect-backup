        ...
        {hasAdminPanels && (
          <>
            ...
            <DropdownMenuGroup>
                ...
                {isSuperAdmin && <DropdownMenuItem asChild><Link href="/admin/content?tab=opportunity-map" className="cursor-pointer font-body"><Target className="mr-2 h-4 w-4" /><span>Mapa de Oportunidades</span></Link></DropdownMenuItem>}
