        ...
        {isAdmin && (
          <>
            ...
            <DropdownMenuGroup>
                ...
                {isSuperAdmin && <DropdownMenuItem asChild><Link href="/workflow-analytics" className="cursor-pointer font-body"><BarChart className="mr-2 h-4 w-4" /><span>Análise de Workflows</span></Link></DropdownMenuItem>}
